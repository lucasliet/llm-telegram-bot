...
Deno.test(
	'Instantiate OpenAI-related service classes constructors',
	async () => {
		const kvCleanup = setupKvStub();
		...
		try {
			const Gemini = (await import('../../src/service/openai/GeminiService.ts'))
				.default;
			const OpenWebUI = (
				await import('../../src/service/openai/OpenWebUIService.ts')
			).default;
			const Openrouter = (
				await import('../../src/service/openai/OpenrouterService.ts')
			).default;
			const Perplexity = (
				await import('../../src/service/openai/PerplexityService.ts')
			).default;
			const GithubCopilot = (
