...
export default class ToolService {
      ...
      "search_searx",
      {
        schema: {
          ...
          function: {
            name: "search_searx",
            description:
              "Search the web using SearxNG instances to get recent and relevant information",
            parameters: {
              type: "object",
              properties: {
      ...
      "fetch",
      {
        schema: {
          ...
          function: {
            name: "fetch",
            description:
              "Fetches a URL via HTTP GET and returns its content in response as text",
            parameters: {
              type: "object",
              properties: {
      ...
      "copilot_usage",
      {
        schema: {
          ...
          function: {
            name: "copilot_usage",
            description:
              "Checks GitHub Copilot usage associated with COPILOT_GITHUB_TOKEN environment variable and returns account usage info as JSON",
            parameters: {
              type: "object",
              properties: {},
              additionalProperties: false,
            ...
            parameters: {
              ...
              properties: {
                ...
                preferredLanguages: {
                  ...
                  items: { type: "string" },
                  description:
                    "Uma lista opcional de códigos de idioma preferenciais (ex: ['pt-BR', 'en']).",
                },
              },
              required: ["videoUrl"],
              additionalProperties: false,
        ...
        fn: async (args: {
          ...
          const parseSegments = (xml: string): YouTubeTranscriptSegment[] => {
            ...
            if (
              ...
              const items = Array.isArray(transcriptTexts)
                ? transcriptTexts
                : [transcriptTexts];
            ...
            return items.flatMap((p) => {
              ...
              const texts = p.s
                ? (Array.isArray(p.s) ? p.s : [p.s]).map((s: any) =>
  ...
  static responsesSchemas: OpenAi.Responses.Tool[] =
